		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#employee1employeedatafilterproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employee1employeedatafilterproject-display": {
								"semanticObject": "employee1employeedatafilterproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employee1.employeedatafilterproject",
									"url": sap.ui.require.toUrl("employee1/employeedatafilterproject")
								}
							}
						}
					}
